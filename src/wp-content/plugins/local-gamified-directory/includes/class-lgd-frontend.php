...
%3$s',
        ...
        public function render_business_submission_form() {
                ...
                <form class="lgd-form" method="post" enctype="multipart/form-data">
                        ...
                        <div class="lgd-form__actions">
                                <button type="submit" class="lgd-button lgd-button--primary"><?php esc_html_e( 'Submit Business', 'local-gamified-directory' ); ?></button>
                        </div>
                </form>
                <?php
        ...
        public function render_classified_submission_form() {
                ...
                <form class="lgd-form" method="post" enctype="multipart/form-data">
                        ...
                        <div class="lgd-form__actions">
                                <button type="submit" class="lgd-button lgd-button--primary"><?php esc_html_e( 'Submit Classified', 'local-gamified-directory' ); ?></button>
                        </div>
                </form>
                <?php
                return $this->wrap_form_output( ob_get_clean() );
                                        ...
                                        <table class="lgd-table">
                                                ...
                                                <tbody>
                                                        <?php foreach ( $businesses as $business ) : ?>
                                                                <tr>
                                                                        <td>
                                                                                <a href="<?php echo esc_url( get_permalink( $business ) ); ?>">
                                                                        ...
                                                                        <td class="lgd-table__actions">
                                                                                <a class="lgd-button lgd-button--small" href="<?php echo esc_url( get_edit_post_link( $business ) ); ?>">
                                        ...
                                        <table class="lgd-table">
                                                ...
                                                <tbody>
                                                        <?php foreach ( $classifieds as $classified ) :
                                                                ...
                                                                <tr>
                                                                        <td>
                                                                                <a href="<?php echo esc_url( get_permalink( $classified ) ); ?>">
                                                                        ...
                                                                        <td class="lgd-table__actions">
                                                                                <a class="lgd-button lgd-button--small" href="<?php echo esc_url( get_edit_post_link( $classified ) ); ?>">
                                                                                        <?php esc_html_e( 'Edit', 'local-gamified-directory' ); ?>
                                                                                </a>
                                                                        </td>
                                                                </tr>
