...
class LGD_Gamification {
	...
	public function render_admin_page() {
	        ...
	        if ( ! $this->plugin->is_feature_enabled( 'gamification' ) ) {
	                echo '<div class="notice notice-info"><p>' . esc_html__( 'Gamification tools are currently disabled.', 'local-gamified-directory' ) . '</p></div>';
	                return;
	        }
	...
	public function render_leaderboard_shortcode( $atts ) {
	        if ( ! $this->plugin->is_feature_enabled( 'leaderboard' ) || ! $this->plugin->is_feature_enabled( 'gamification' ) ) {
	                return '<div class="lgd-notice lgd-notice--info">' . esc_html__( 'Leaderboards are currently unavailable.', 'local-gamified-directory' ) . '</div>';
	        }
	        $atts = shortcode_atts(
	                array(
	                        'type' => 'all_time',
